...
The Fisheries Integrated Toolbox has a [Code of Conduct](https://github.com/nmfs-fish-tools/Resources/blob/master/CODE_OF_CONDUCT.md) in its [Resources](https://github.com/nmfs-fish-tools/Resources) repo.  Copy the contents if you want to use it.
...
* You put this in your repo, here's an example from the [Toolbox](https://github.com/nmfs-fish-tools/SSMSE).
