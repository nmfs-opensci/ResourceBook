...
Special comments re licenses for open source software. CC0 [does not recommend the license for software](https://creativecommons.org/faq/#can-i-apply-a-creative-commons-license-to-software) but instead recommend using an open source license designed for software. If you want to publish your tool in the Journal of Open Source Software, for example, CC0 is not acceptable because it is not one of the [listed open source licenses](https://opensource.org/licenses/) on the Open Source Initiative.
...
This shows an example of the license for the [MARSS package](https://github.com/atsa-es/MARSS) with the license addendum above added to the LICENSE file.
